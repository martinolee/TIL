...
- Required Initializer
    ...
    - 서브 클래스에서는 해당 초기화 메서드를 반드시 작성해주어야 하며, `override` 키워드 생략 가능
        ...
        class Song {
            ...
            // Designated Initializer		
            init(name: String, artist: String, releaseYear: Int, album: String, genre: String) {
                self.name = name
                self.artist = artist
            ...
            // Failable Initializer
            init?(name: String, artist: String, releaseYear: Int, album: String, genre: String, isNew: Bool) {
